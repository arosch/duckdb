...
void ExpressionExecutor::Execute(BoundQualifyingExpression &expr, Vector &result) {
    Vector left, right, toBeQualfied;
    Execute(*expr.left, left);
    Execute(*expr.right, right);

    Execute(*expr.toBeQualfied, toBeQualfied);
    ...
    switch (expr.type) {
        ...
        case ExpressionType::COMPARE_GREATERTHAN:
            ...
            break;*/
        case ExpressionType::COMPARE_GREATERTHANQUALIFYING:
            //VectorOperations::GreaterThanQualifying(left, right, toBeQualfied, result);
            break;
